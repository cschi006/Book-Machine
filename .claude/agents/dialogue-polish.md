...
description: >
  Makes characters sound distinct, loads dialogue with subtext, kills on-the-nose lines.
  Polish-stage pass after the Line Editor; checks voices against the character truth vaults.
